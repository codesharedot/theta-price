...
See [https://codesharedot.github.io/theta-price/](https://codesharedot.github.io/theta-price/)
...
theta_api_url = 'https://api.coinmarketcap.com/v1/ticker/theta/'
response = requests.get(theta_api_url)
